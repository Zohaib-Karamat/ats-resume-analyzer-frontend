...
export function AISummaryCard({ summary }) {
  return (
    <div className="relative flex min-h-[200px] w-full overflow-hidden rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 p-[1px] shadow-sm sm:min-h-[220px]">
      <div className="relative flex h-full w-full flex-col justify-center rounded-xl bg-white p-5 sm:p-6 dark:bg-zinc-950">
